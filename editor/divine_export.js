...
(function (root, factory) {
  ...
  else root.DivineExport = factory();
  ...
  function header(slide, eyebrow, title, prioridade, statusGeral) {
    ...
    logo(slide);
    slide.addText(eyebrow, { x: 1.08, y: 0.155, w: 8.0, h: 0.25, fontSize: 10, bold: true, color: C.GOLDLT, fontFace: FONT, margin: 0 });
    slide.addText(title, { x: 1.06, y: 0.375, w: 8.0, h: 0.55, fontSize: 25, bold: true, color: C.WHITE, fontFace: FONT, margin: 0 });
    if (prioridade) {
